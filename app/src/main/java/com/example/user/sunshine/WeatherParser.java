...
//    //Will be called from the Fetch Weather Task and JSON will be passed for formatting
//    public static double getMaxTemp(String jsonString, int dayIndex) {
//
//        try {
//
